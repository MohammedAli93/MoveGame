...
public class MovingPlatform : MonoBehaviour
{
    ...
    public MovingPlatformType platformType = MovingPlatformType.NEWMOVE;
    ...
    public bool FaceNextNode;
    public float FixOrientation;
    ...
    private void FixedUpdate()
    {
        ...
        while(distanceToGo > 0)
        {
                    ...
                    { //we reach the end
                        ...
                        switch(platformType)
                        {
                            ...
                            case MovingPlatformType.ONCE:
                                ...
                                StopMoving();
                                break;
                            case MovingPlatformType.NEWMOVE:
            ...
            if (FaceNextNode)
            {
                var dir = localNodes[m_Next] - transform.localPosition;
                var angle = Mathf.Atan2(dir.y, dir.x) * Mathf.Rad2Deg - FixOrientation;
